...
if __name__ == "__main__":
        ...
        while True:
                ...
                if count%60 == 0:
                        ...
                        tmp_res = json.loads(getData("http://localhost:9090/cmd$
                        now_count = str(tmp_res['Content']['content'])
                        sense.show_message( now_count[2:-2] + " rows", scroll_s$
                        sense.load_image("logo8.png")
                ...
                stmt = stmt + str(humidity) + "','"  + str(temp) + "','" + str($
                stmt = stmt + "','" + str(roll) + "','" + str(yaw) + "','" + st$
